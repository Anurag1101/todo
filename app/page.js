...
export default function Home() {
  ...
  return (
    <div className="my-2 container min-h-screen font-semibold text-3xl">
      <h1 className="flex justify-center items-start w-full pt-10">Create Your Todo</h1>
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
          <div className=" bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
            ...
            <button
              onClick={addTodo}
              className="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none w-fit
